#ifndef __TYPHON_UTILS_LOG_HPP__
#define __TYPHON_UTILS_LOG_HPP__


// 与 typhon Makefile 的 -DSPDLOG_COMPILED_LIB 配套:
// 下游 include 本 header 时自动获得 compiled 模式,避免 header-only inline
// 与 libtyphon.a 内的 compiled spdlog 符号产生 weak/strong 混用。
...
#endif // __TYPHON_UTILS_LOG_HPP__