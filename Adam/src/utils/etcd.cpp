...
int
adam::utils::EtcdRsp::deserialize(EtcdRsp* out, const std::string& json) noexcept {
...
int
adam::utils::etcd_auth(EtcdRsp* rsp, const char* url, const char* user, const char* pwd) noexcept {
...
int
adam::utils::etcd_grant(EtcdRsp* rsp, const char* url, int ttl) noexcept {
...
int
adam::utils::etcd_put(EtcdRsp* rsp, const char* url, const char* token, const char* key, const char* val, const char* lease) noexcept {
...
int
adam::utils::etcd_keepalive(EtcdRsp* rsp, const char* url, const char* token, const char* lease) noexcept {
...
int
adam::utils::etcd_delete(EtcdRsp* rsp, const char* url, const char* token, const char* key) noexcept {
...
int
adam::utils::etcd_get_prefix(EtcdRsp* rsp, const char* url, const char* token, const char* prefix) noexcept {
